...
export const ACTIVITY_DESCRIPTIONS: Record<ActivityLevel, string> = {
  sedentary: 'Maintien en station, peu ou pas d\'exercice',
  light: 'Service léger, 1-3 séances d\'exercice / semaine',
  moderate: 'Service standard, 3-5 séances / semaine',
  active: 'Service intense ou EVA, 6-7 séances / semaine',
  extreme: 'Programme EVA intensif ou entraînement bi-quotidien',
};
...
export const DISCLAIMER =
  'Estimations calculées sur l\'appareil à partir d\'équations de référence ' +
  'publiées (Mifflin-St Jeor, FAO/WHO PAL, IOM DRI). Ce ne sont pas des ' +
  'conseils médicaux personnalisés et ne remplacent pas l\'évaluation d\'un médecin de vol.';
